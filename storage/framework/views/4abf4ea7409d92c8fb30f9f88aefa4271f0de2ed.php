...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        ...
        <button onclick="window.location='<?php echo e(url("/glossary")); ?>'" style="background-color: #8732a8" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-12 mt-6 w-48">
            Go to Glossary
        </button>
	...
	<path d="M183.028,43.028H96.972C43.501,43.028,0,86.529,0,140s43.501,96.972,96.972,96.972h86.057
        ...
        <button onclick="window.location='<?php echo e(url("/play")); ?>'" style="background-color: #8732a8" class="hover:bg-blue-700 text-white font-bold py-2 px-4 rounded rounded ml-12 mt-6 w-48">
            Play games
        </button>
    </div>
...
<?php /**PATH /Users/wojciechreluga/University/level 6/Enterprise system development/Medical-App/resources/views/vendor/jetstream/components/welcome.blade.php ENDPATH**/ ?>