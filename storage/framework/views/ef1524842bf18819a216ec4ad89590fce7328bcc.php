...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-12">
		...
		l42.208-35.29C183.681,145.113,183.681,134.887,177.029,129.326z"/>
                        ...
                        <button onclick="window.location='<?php echo e(url("/play/quiz")); ?>'" style="background-color: #8732a8" class="hover:bg-blue-700 text-white font-bold py-2 px-4 rounded rounded ml-12 mt-6 w-48">
                            Start Quiz
                        </button>
                    </div>
...
<?php endif; ?>
<?php /**PATH /Users/wojciechreluga/University/level 6/Enterprise system development/Medical-App/resources/views/play/index.blade.php ENDPATH**/ ?>